...
function Footer() {
    return (  
        ...
        <div className='container vorder-top mt-5'>
            <div className='row mt-5'>
                <div className='col mt-4'>
                    <img src='media/images/logo.svg' className="mb-3"style={{width:"50%"}}></img>
                    <p>© 2010 - 2024, Zerodha<br></br>Broking Ltd.<br></br> All rights reserved.</p>
                </div>
